...
create table `order` (id integer GENERATED BY DEFAULT AS IDENTITY, city varchar(255), country varchar(255), county varchar(255), street_address varchar(255), customer integer, shipped_from integer, primary key (id));
